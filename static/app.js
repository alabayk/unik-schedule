...
const knownEmails={'Фирсова Ирина Владленовна':'ivfirsova@fa.ru','Смирнова Елена Валентиновна':'evsmirnova@bmstu.ru'};function emailFor(x){if(x.teacherEmail)return x.teacherEmail;for(const name in knownEmails)if((x.teacher||'').includes(name))return knownEmails[name];return'Почта не указана'}
