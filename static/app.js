...
function moveDay(step){showPast=false;selected+=step;if(selected>6){monday=addDays(monday,7);selected=0;load();return}if(selected<0){monday=addDays(monday,-7);selected=6;load();return}renderDays();renderLessons()}
